...
function startup(viewer) {
    ...
    var length = 4000.0;
    // 1.2 地面位置(垂直地面)
    var positionOnEllipsoid = Cesium.Cartesian3.fromDegrees(118.124512, 38.296794);
    // 1.3 中心位置
    var centerOnEllipsoid = Cesium.Cartesian3.fromDegrees(118.124512, 38.296794, length * 0.5);
    // 1.4 顶部位置(卫星位置)
    var topOnEllipsoid = Cesium.Cartesian3.fromDegrees(118.124512, 38.296794, length);
    // 1.5 矩阵计算
